...
void reset (char[][COL],const int, int);   //Resets board 
...
int main(int argc, char** argv) {
    ...
    int num;                        //Used in the reset function, is a 
                                    //default parameter
   ...
   for (int i=0; i<ROW; i++){
    ...
    do{
        ...
        if (over=true){           
            cout<<"\n*************************************\n";
            cout<<setw(24)<<"Game Over!"<<setw(10)<<endl;
            cout<<"*************************************\n";
        }   
...
void displayGrid(char grid[][COL], const int ROW){
    ...
    //It would have been easier to understand if I outputted spaces instead 
    //of using setw(), but I wanted to demonstrate that I know how to use 
    //iomanip to format my code. It works either way :)
    cout<<setw(14)<<"|"<<setw(11)<<"|"<<endl;
    cout<<setw(8)<<grid[0][0]<<setw(6)<<"|"<<setw(5)<<grid[0][1]<<setw(6)<<"|";
    cout<<setw(6)<<grid[0][2]<<endl;
    cout<<"   __________|__________|__________"<<endl;
    cout<<setw(14)<<"|"<<setw(11)<<"|"<<endl;
    cout<<setw(8)<<grid[1][0]<<setw(6)<<"|"<<setw(5)<<grid[1][1]<<setw(6)<<"|";
    cout<<setw(6)<<grid[1][2]<<endl;
    cout<<"   __________|__________|__________"<<endl;
    cout<<setw(14)<<"|"<<setw(11)<<"|"<<endl;
    cout<<setw(8)<<grid[2][0]<<setw(6)<<"|"<<setw(5)<<grid[2][1]<<setw(6)<<"|";
    cout<<setw(6)<<grid[2][2]<<endl;
    cout<<setw(14)<<"|"<<setw(11)<<"|"<<endl;
}
...
void menu(){
    ...
    //Output options 
    //For outputting rules, I wasn't sure how to output a paragraph from a file
    //For some reason, it wouldn't read in the spaces. 
    //I did however use file input/output in other parts of my code!!
    switch(choice){
        case '1':
            cout<<endl;
            break;
...
//Resets board
//Here I used a default parameter, num
void reset (char grid[][COL], const int ROW, int num=1){
    for (int i=0; i<ROW; i++){
        for (int j=0; j<COL; j++ ){
            grid[i][j]=(num+'0');
            num++;
